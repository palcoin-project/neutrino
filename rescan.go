...
type ChainSource interface {
	...
	GetBlock(chainhash.Hash, ...QueryOption) (*palcutil.Block, error)
...
func WatchAddrs(watchAddrs ...palcutil.Address) RescanOption {
	return func(ro *rescanOptions) {
...
func extractBlockMatches(chain ChainSource, ro *rescanOptions,
	curStamp *headerfs.BlockStamp, filter *gcs.Filter) ([]*palcutil.Tx,
	error) {
	...
	relevantTxs := make([]*palcutil.Tx, 0, len(block.Transactions()))
...
func (ro *rescanOptions) spendsWatchedInput(tx *palcutil.Tx) bool {
...
func (ro *rescanOptions) paysWatchedAddr(tx *palcutil.Tx) (bool, error) {
...
func AddAddrs(addrs ...palcutil.Address) UpdateOption {
