...
import (
	...
	"github.com/palcoin-project/neutrino/chainsync"
	"github.com/palcoin-project/neutrino/headerfs"
	"github.com/palcoin-project/neutrino/headerlist"
...
type blockManagerCfg struct {
	...
	GetBlock func(chainhash.Hash, ...QueryOption) (*palcutil.Block, error)
...
func resolveFilterMismatchFromBlock(block *wire.MsgBlock,
	...
	for peerAddr, filter := range filtersFromPeers {
		...
		numOpReturns, err := VerifyBasicBlockFilter(
			filter, palcutil.NewBlock(block),
		)
		if err != nil {
...
func (b *blockManager) checkHeaderSanity(blockHeader *wire.BlockHeader,
	...
	stubBlock := palcutil.NewBlock(&wire.MsgBlock{
		Header: *blockHeader,
	})
