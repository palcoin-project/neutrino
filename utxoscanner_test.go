...
type MockChainClient struct {
	getBlockResponse     map[chainhash.Hash]*palcutil.Block
...
func TestUtxoScannerScanBasic(t *testing.T) {
	...
	mockChainClient.SetBlock(&block99999Hash, palcutil.NewBlock(&Block99999))

	block100000Hash := Block100000.BlockHash()
	mockChainClient.SetBlockHash(100000, &block100000Hash)
	mockChainClient.SetBlock(&block100000Hash, palcutil.NewBlock(&Block100000))
...
// The following is taken from the palcoin-project/palcutil project.
